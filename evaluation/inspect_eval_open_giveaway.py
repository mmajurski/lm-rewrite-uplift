"""Inspect-ai evaluation runner: questions with giveaway context prepended."""
import sys, os
...
def base_task(lcl_fp, question_key):
    """Build a task where the context is prepended to the question as a giveaway."""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--question_key', type=str, default='orig_question')  # ['orig_question', 'reformat_question']
    ...
    for ds in ['oe-gpt120b-filtered', 'oe-gpt20b-filtered']:
        ...
        for task_name in available_task_names:
            ...
            eval(work_tasks, model=models_list, display=disp_type, log_format='json',
                 no_log_images=True, no_log_samples=True, log_dir=log_dir, max_connections=16)
