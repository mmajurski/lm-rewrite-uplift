"""Score how much a rewritten question reveals the answer (answer giveaway metric)."""
import sys, os
...
def compute_meta_scores(dataset_fp, remote, model, reformat:bool, force_flag:bool):
    ...
    model = SglModelAsync(remote=remote, model=model, connection_parallelism=32, reasoning_effort='high')
...
if __name__ == '__main__':
    ...
    remote = os.getenv("VLLM_BASE_URL")
    model = 'gpt-oss-120b'
