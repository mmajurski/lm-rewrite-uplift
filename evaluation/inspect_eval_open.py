"""Inspect-ai evaluation runner: original or reformat questions, no giveaway context."""
import sys, os
...
if __name__ == '__main__':
    ...
    parser.add_argument('--question_key', type=str, required=True)  # ['orig_question', 'reformat_question']
