...
for dataset_fldr in ['data-post-cutoff','data-subset-500', 'data-subset-500-SU','data-post-cutoff-afc','data-subset-500-afc']:
    for generating_model_name in ['gpt120b', 'Q235B']:
        ...
        for embedding_model in embedding_models:
            ...
            plt.xlabel('Dataset Delta Accuracy (Reformat - Orig)')
            plt.ylabel('Dataset Delta Embedding Cosine (embR_embC - embO_embC)')
            ...
            plt.title(f'Delta Accuracy vs Delta Embedding ({embedding_model})')
