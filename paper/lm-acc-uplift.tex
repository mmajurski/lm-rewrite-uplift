...
\documentclass[sigconf, authordraft,anonymous]{acmart} % authordraft
...
\acmConference[ACM CAIS 2026]{ACM Conference on AI and Agentic Systems}{May 26-29, 2026}{San Jose, CA}
%[Conference acronym 'XX]{Make sure to enter the correct conference title from your rights confirmation email}{June 03--05,	2018}{Woodstock, NY}
...
%\renewcommand{\shortauthors}{Majurski et al.}
...
\begin{abstract}
	How carefully and unambiguously a question is phrased has a profound impact on the quality of the response, for Language Models (LMs) as well as people.
	While model capabilities continue to advance, the interplay between grounding context and query formulation remains under-explored.
...
\keywords{AI, Query Rewriting, Benchmarking}
